...
LDFLAGS+=
CXXFLAGS+=$(FLAGS) $(INCLUDES) $(DEFINES) -DINL_EXPE=inline
...
YANS_INCLUDES:=\
 ...
 $(NULL)
YANS_CXXFLAGS:=$(CXXFLAGS) $(YANS_INCLUDES)
YANS_CFLAGS:=$(CFLAGS) $(YANS_INCLUDES)
...
SAMPLE_CXX_TRACE_SRC:= \
	samples/main-trace.cc \
	$(NULL)
SAMPLE_CXX_TRACE_NAME:=main-trace
SAMPLE_CXX_TRACE_TYPE:=executable
SAMPLE_CXX_TRACE_CXXFLAGS:=$(CXXFLAGS)
SAMPLE_CXX_TRACE_LDFLAGS:=$(LDFLAGS) -lyans $(TC_LDFLAGS)
...
SAMPLE_CXX_EVENT_SRC:= \
	samples/main-event.cc \
	$(NULL)
SAMPLE_CXX_EVENT_NAME:=main-event
SAMPLE_CXX_EVENT_OUTPUT_DIR:=
SAMPLE_CXX_EVENT_TYPE:=executable
SAMPLE_CXX_EVENT_CXXFLAGS:=$(CXXFLAGS)
SAMPLE_CXX_EVENT_LDFLAGS:=$(LDFLAGS) -lyans $(TC_LDFLAGS)

SAMPLE_CXX_CALLBACK_SRC:= \
	samples/main-callback.cc \
	$(NULL)
SAMPLE_CXX_CALLBACK_NAME:=main-callback
SAMPLE_CXX_CALLBACK_OUTPUT_DIR:=
SAMPLE_CXX_CALLBACK_TYPE:=executable
SAMPLE_CXX_CALLBACK_CXXFLAGS:=$(CXXFLAGS)
SAMPLE_CXX_CALLBACK_LDFLAGS:=$(LDFLAGS) -lyans $(TC_LDFLAGS)

SAMPLE_CXX_PACKET_SRC := \
	samples/main-packet.cc \
	$(NULL)
SAMPLE_CXX_PACKET_NAME:=main-packet
SAMPLE_CXX_PACKET_TYPE:=executable
SAMPLE_CXX_PACKET_CXXFLAGS:=$(CXXFLAGS)
SAMPLE_CXX_PACKET_LDFLAGS:=$(LDFLAGS) -lyans $(TC_LDFLAGS)
...
SAMPLE_CXX_80211_AP_SRC:= \
	samples/main-80211-ap.cc \
	$(NULL)
SAMPLE_CXX_80211_AP_NAME:=main-80211-ap
SAMPLE_CXX_80211_AP_OUTPUT_DIR:=
SAMPLE_CXX_80211_AP_TYPE:=executable
SAMPLE_CXX_80211_AP_CXXFLAGS:=$(CXXFLAGS)
SAMPLE_CXX_80211_AP_LDFLAGS:=$(LDFLAGS) -lyans $(TC_LDFLAGS)
