...
class Callback<R (T1, T2, T3, T4)> : public CallbackBase {
 public:
	virtual ~Callback () {}
...
class Callback4 : public Callback<R (T1, T2, T3, T4)> {
public:
	typedef R (T::*F) (T1, T2, T3, T4);

	Callback4 (T *obj, F function) 
		: m_obj (obj), 
		  m_function (function) 
	{}
	virtual R operator() (T1 a1, T2 a2, T3 a3, T4 a4) {
		return (m_obj->*m_function) (a1, a2, a3, a4);
	}
private:
	Callback4 () {}
	T *m_obj;
...
template<typename T, typename R, typename T1, typename T2, typename T3, typename T4>
Callback4<T, R, T1, T2, T3, T4> *make_callback(R (T::*f) (T1, T2, T3, T4), T* t) {
	return new Callback4<T, R, T1, T2, T3, T4>(t, f);
}
