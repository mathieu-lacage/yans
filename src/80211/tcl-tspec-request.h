...
#ifndef TCL_TSPEC_REQUEST_H
#define TCL_TSPEC_REQUEST_H
...
private:
	...
	std::string m_tclTspec;
	std::string m_grantedCallback;
	std::string m_refusedCallback;
};

#endif /* TCL_TSPEC_REQUEST_H */
